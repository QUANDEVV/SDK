...
func (o *PatchedCustomerFeedback) GetCustomerFeedbackId() int32 {
	if o == nil || o.CustomerFeedbackId == nil {
		var ret int32
		return ret
	}
...
func (o *PatchedCustomerFeedback) GetFeedbackText() string {
	if o == nil || o.FeedbackText.Get() == nil {
		var ret string
		return ret
	}
...
// GetFeedbackCategory returns the FeedbackCategory field value if set, zero value otherwise (both if not set or set to explicit null).
...
func (o *PatchedCustomerFeedback) GetFeedbackCategoryOk() (*FeedbackCategoryEnum, bool) {
	if o == nil || o.FeedbackCategory == nil {
		return nil, false
	}
