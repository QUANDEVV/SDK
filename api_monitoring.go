...
func (r ApiMonitoringConnectorsRetrieveRequest) Execute() (*_nethttp.Response, error) {
...
*/
func (a *MonitoringApiService) MonitoringConnectorsRetrieve(ctx _context.Context) ApiMonitoringConnectorsRetrieveRequest {
	return ApiMonitoringConnectorsRetrieveRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MonitoringApiService) MonitoringConnectorsRetrieveExecute(r ApiMonitoringConnectorsRetrieveRequest) (*_nethttp.Response, error) {
	var (
